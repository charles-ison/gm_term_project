...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--dataroot', type=str, default='datasets/shrec_16', help='path to meshes (should have subfolders train, test)')
        ...
        self.parser.add_argument('--name', type=str, default='shrec16', help='name of the experiment. It decides where to store samples and models')
